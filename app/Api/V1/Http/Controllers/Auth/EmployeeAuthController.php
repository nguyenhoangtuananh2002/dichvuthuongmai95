...
use App\Api\V1\Http\Requests\Employee\{EmployeeRegisterRequest, EmployeeLoginRequest, EmployeeUpdateRequest, EmployeeUpdatePasswordRequest};
...
use App\Api\V1\Http\Resources\Auth\AuthResource1;
...
class EmployeeAuthController extends Controller
{
    ...
    public function show(Request $request){
        return response()->json([
            ...
            'data' => new AuthResource1($request->user())
        ]);
    }
    ...
    public function login(EmployeeLoginRequest $request)
    {
        ...
        $employee = Auth::guard('employee')->getProvider()->retrieveByCredentials($credentials);
        if ($employee && Auth::guard('employee')->getProvider()->validateCredentials($employee, $credentials)) {
            // Create token
            $token = $employee->createToken(config('custom_api.token_auth'))->plainTextToken;
    ...
    public function update(EmployeeUpdateRequest $request){
        ...
        return response()->json([
            'status' => 200,
            'message' => __('Thực hiện thành công.'),
            'data' => new AuthResource1($employee)
        ], 200);
    }
     ...
     * }
     *
     * @param EmployeeUpdatePasswordRequest $request
     *
     * @return JsonResponse
     */
    public function updatePassword(EmployeeUpdatePasswordRequest $request){
